  ...
  add_settings_field(
    ...
    function () {
      echo '
        ...
        <p class="description" id="prefetch-container-description">'.__('CSS selector for container. Only links in this container will be prefetched').'</p>
      ';
    }, 
    'reading',
    'prefetch_section'
